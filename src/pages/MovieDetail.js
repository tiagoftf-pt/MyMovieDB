...
export const MovieDetail = ({ apiPath }) => {
  ...
  document.title = `${movie.title} / MyMovieDB`
    ...
    <main>
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 dark:text-white text-lg">
          ...
          <p className="my-4">
            <span className="font-bold mr-2">Runtime:</span><span>{movie.runtime} min.</span>
          </p>
          <p className="my-4">
            <span className="font-bold mr-2">Budget:</span><span>{movie.budget} €</span>
          </p>
          <p className="my-4">
            <span className="font-bold mr-2">Revenue:</span><span>{movie.revenue} €</span>
          </p>
          <p className="my-4">
            <span className="font-bold mr-2">Release Date:</span><span>{movie.release_date}</span>
          </p>
          <p className="my-4">
            <span className="font-bold mr-2">IMDB Code:</span><a href={`https://www.imdb.com/title/${movie.imdb_id}`} target="_blank" rel="noreferrer">{movie.imdb_id}</a>
          </p>
        </div>
      </section>
    </main>
